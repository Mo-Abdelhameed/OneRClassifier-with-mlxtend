...
def create_instance_model(schema: ClassificationSchema) -> BaseModel:
    """
    Creates a dynamic Pydantic model for instance validation based on the schema.

    Args:
        schema (ClassificationSchema): The classification schema.
...
def get_inference_request_body_model(schema: ClassificationSchema) -> BaseModel:
    """
