...
class ClassificationSchema:
    """
    A class for loading and providing access to a binary/multiclass classification schema.
...
def load_json_data_schema(schema_dir_path: str) -> ClassificationSchema:
    ...
    Returns:
        ClassificationSchema: An instance of the
...
def save_schema(schema: ClassificationSchema, save_dir_path: str) -> None:
    ...
    Args:
        schema (ClassificationSchema): The schema to be saved.
